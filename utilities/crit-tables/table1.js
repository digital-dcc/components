export const I = {
  ...
  1: {
    roll: 1,
    result: 'Opportunistic strike. Inflict +1d3 damage with this strike.',
  },
  2: {
    roll: 2,
    result:
  ...
  5: {
    roll: 5,
    result: 'Solid strike to torso. Inflict +1d6 damage with this strike.',
  },
  6: {
    roll: 6,
    result:
  ...
  11: {
    roll: 11,
    result: 'Piercing strike. Inflict +2d4 damage with this strike.',
  },
  12: {
    roll: 12,
    result:
  ...
  13: {
    roll: 13,
    result: 'Blow smashes foe’s ankle; his movement speed is reduced by half.',
  },
  14: {
    roll: 14,
    result: 'Strike grazes temple; blood blinds the foe for 1d3 rounds.',
  },
  15: {
    roll: 15,
    result:
