export const table2 = {
  ...
  3: {
    roll: 3,
    result: 'Clean strike to back. Inflict +2d6 damage with this strike.',
  },
  4: {
    roll: 4,
    result:
  ...
  10: {
    roll: 10,
    result: 'Masterful strike! Inflict +2d6 damage with this strike.',
  },
  11: {
    roll: 11,
    result: 'Strike severs larynx. Foe is reduced to making wet fish noises.',
  },
  12: {
    roll: 12,
    result:
