export const table3 = {
  ...
  1: {
    roll: 1,
    result: 'Savage attack! Inflict +1d6 damage with this strike.',
  },
  2: {
    roll: 2,
    result: 'Attack sweeps foe off his feet. Next round, the enemy is prone.',
  },
  3: {
    roll: 3,
    result: 'Foe steps into attack. Inflict +1d8 damage with this strike.',
  },
  4: {
    roll: 4,
    result: 'Powerful strike hammers foe to his knees. Make another attack.',
  },
  5: {
    roll: 5,
    result:
  ...
  10: {
    roll: 10,
    result: 'Sunder foe’s weapon! Shards of metal fill the air.',
  },
  11: {
    roll: 11,
    result:
  ...
  12: {
    roll: 12,
    result:
      'Blow to cranium staggers foe. The foe must make a Fort save (DC 10 + PC level) or sink to floor, unconscious.',
  },
  13: {
    roll: 13,
    result:
  ...
  14: {
    roll: 14,
    result: 'Attack hammers foe’s torso. Inflict +2d8 damage with this strike.',
  },
  15: {
    roll: 15,
    result:
  ...
  17: {
    roll: 17,
    result: 'Furious blows hammer target prone. Make another attack.',
  },
  18: {
    roll: 18,
    result:
